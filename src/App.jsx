        ...
        <div className="flex-1 relative overflow-hidden">
          ...
          >
            <RefProvider>
              ...
              2024. 기억할 필요 없어 그게 아름다운 점이지. 마테이 야보르닉. 시빅.
              2023. 그가 말을 하지 않는 이유는 폭소를 간신히 참고 있기 때문이다.
              누스랏 시슬랴니코프. 무하. 비로소 보이는군 대낮처럼 훤히.{" "}
              <R i={3} />. 조지 베일리. 선셋. 山曰く/全部投げろ、掃け/一本勝負だ。
              弁天橋 · バイロン。 2022. 백 색 왜성. 데시데리오 소사. 골드 맨
              맨해튼. 아뇰로 트리폴리.
            </RefProvider>{" "}
          </div>
          <div
          ...
          />
          <div
            className="pointer-events-none absolute bottom-0 left-0 right-0 h-[2em] z-10"
            style={{
              background:
